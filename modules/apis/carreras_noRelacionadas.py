...
class CarrerasNoRelacionadasResource(Resource):    
        ...
        def get(self, carrera_type=None):
            if not carrera_type:
                ...
                print('ENTRE EN carrera_type == obtener_universidades: aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa')
                universidades = gestor_carrera().consultar_universidades_noRelacionadas()
        ...
        def post(self, carrera_type=None):
            ...
            if (carrera_type == 'obtener_facultades'):
                ...
                facultads = gestor_carrera().consultar_facultades_noRelacionadas()
                ...
                campuses = gestor_carrera().consultar_campus_noRelacionadas()
                ...
                programas = gestor_carrera().consultar_programas_noRelacionadas()
